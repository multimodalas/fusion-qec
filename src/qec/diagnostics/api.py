"""
Stable public API for QEC diagnostics.

This module centralizes all public diagnostic exports so that
``__init__.py`` can simply re-export from here.  New diagnostics
should be added to this file rather than editing ``__init__.py``
directly, reducing merge conflicts.
...
# ── Spectral diagnostics (v6.0–v8.1) ───────────────────────────
